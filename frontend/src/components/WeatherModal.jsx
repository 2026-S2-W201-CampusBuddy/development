...
export default function WeatherModal({ isOpen, onClose }) {
  ...
  return (
    <div className="modalBackdrop" onClick={onClose}>
      <div className="modalDialog hubModalDialog weatherDialog" onClick={(e) => e.stopPropagation()}>
            ...
            <>
              ...
              <div className="weatherNotifyRow">
                {permission === 'unsupported' ? (
                  ...
                  <p className="weatherStatusText">
                    Notifications are blocked. Enable them in your browser settings to get a daily alert.
                  </p>
                ) : notifyEnabled ? (
                  <button className="btnGlass btnFullWidth" onClick={disableNotifications}>
                    🔔 Morning alerts on — tap to turn off
                  </button>
                ) : (
