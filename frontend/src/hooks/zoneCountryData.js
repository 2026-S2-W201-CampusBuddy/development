// Auto-generated from IANA tzdb (zone1970.tab, authoritative) plus
// moment-timezone country metadata (fills the zones tzdb link-aliases,
// e.g. Accra, Nairobi, Addis Ababa, which share another zone's exact
// time rules but are still their own real, distinct country).
// Covers all 418 timezones the browser knows about, each mapped to its
// real country name — not a continent guess.
const ZONE_TO_COUNTRY = {
  ...
  'America/Brit_Columbia/Golden': 'Canada',
...
export default ZONE_TO_COUNTRY